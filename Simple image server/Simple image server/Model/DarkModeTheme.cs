...
namespace Simple_image_server.Model
{
    ...
    public class DarkModeTheme
    {
        ...
        public DarkModeTheme(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false)
        {
    ...
    public class OSThemeColors
    {
        ...
        public Color Accent { get; set; } = DarkModeTheme.GetWindowsAccentColor();

        public Color AccentOpaque { get; set; } = DarkModeTheme.GetWindowsAccentOpaqueColor();
    ...
    public class MyRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderItemImage(ToolStripItemImageRenderEventArgs e)
        {
            if (e.Item.GetType().FullName == "System.Windows.Forms.MdiControlStrip+ControlBoxMenuItem")
            {
                ...
                using (Image adjustedImage = DarkModeTheme.ChangeToColor(image, _ClearColor))
                {
